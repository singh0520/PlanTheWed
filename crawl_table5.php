...
$target_url = "http://www.justdial.com/".$city."/".$lin."/page-5";
...
?>
      ...
      <div class="pagination">
		<a href="crawl_table4.php" class="page gradient"><<</a>
          ...
          <a href="#" class="page gradient"><span class="page active">5</span></a>
          <a href="crawl_table6.php" class="page gradient">>></a>
	</div>
