...
$target_url = "http://www.justdial.com/".$city."/".$lin."/page-3";
...
?>
      ...
      <div class="pagination">
		<a href="crawl_table2.php" class="page gradient"><<</a>
          <?php echo "<a href=crawl_table.php?i=".$lin." class='page gradient'>1</a>" ?>
          <a href="crawl_table2.php" class="page gradient">2</a>
          <a href="crawl_table3.php" class="page gradient"><span class="page active">3</span></a>
          <a href="crawl_table4.php" class="page gradient">4</a>
          <a href="crawl_table5.php" class="page gradient">5</a>
          <a href="crawl_table4.php" class="page gradient">>></a>
	</div>
