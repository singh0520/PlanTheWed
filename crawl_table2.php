...
$target_url = "http://www.justdial.com/".$city."/".$lin."/page-2";
...
?>
      ...
      <div class="pagination">
		<a href="crawl_table.php" class="page gradient"><<</a>
          <?php echo "<a href=crawl_table.php?i=".$lin." class='page gradient'>1</a>" ?>
          <a href="#" class="page gradient"><span class="page active">2</span></a>
